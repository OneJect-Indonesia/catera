    ...
    public function up(): void
    {
        if (app()->environment('testing')) {
            ...
            DB::table('portal_application.md_permissions')->insert([
                ...
                ['name' => 'catera:md_group:view_any', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
                ['name' => 'catera:md_group:create', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
                ['name' => 'catera:md_group:update', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
                ['name' => 'catera:md_group:delete', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
